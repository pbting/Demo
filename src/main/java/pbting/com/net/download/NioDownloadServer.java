...
public class NioDownloadServer {
	...
	protected String filename = "D:/demo.txt"; // a big file
	protected ByteBuffer clientBuffer = ByteBuffer.allocate(BLOCK);
	protected CharsetDecoder decoder;

	public NioDownloadServer(int port) throws IOException {
	...
	public static void main(String[] args) {
		int port = 12345;
		try {
			NioDownloadServer server = new NioDownloadServer(port);
